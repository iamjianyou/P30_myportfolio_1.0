        ...
        {/* {projects.map((project, i) => ( */}
          ...
          >
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              ProjectsProjectsProjectsProjectsProjectsProjectsProjectsProjectsdfeferferfe Case Study Case Study Case Study Case Study
              2*ProjectsProjectsProjectsPro Case Study
              </p>
            </div>
          </motion.div>
        {/* ))} */}
